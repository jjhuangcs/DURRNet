...
class TrainOptions(BaseOptions):
    def initialize(self):
        ...
        self.parser.add_argument('--nEpochs', '-n', type=int, default=25, help='# of epochs to run')
        ...
        self.parser.add_argument('--lambda_reco', type=float, default=0.2, help='weight for reconstruction loss')#0.2
        self.parser.add_argument('--lambda_excl', type=float, default=0.01, help='weight for exclusion loss')
        self.parser.add_argument('--lambda_ssim', type=float, default=0.0, help='weight for ssim loss')
